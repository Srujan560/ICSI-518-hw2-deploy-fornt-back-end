...
export default function Excuser() {
    ...
    return (
    <div>
        <Button variant="dark" size="lg" onClick={()=>fetchData("office")} aria-controls="my-office" aria-expanded={userExcuse}>Get Office excuse</Button>
        <Button variant="dark" size="lg" onClick={()=>fetchData("party")} aria-controls="my-fade" aria-expanded={userExcuse}>Get party excuse</Button>
        <Button variant="dark" size="lg" onClick={()=>fetchData("college")} aria-controls="fade-college" aria-expanded={userExcuse}>Get College excuse</Button>
        {/* <p>{userExcuse}</p> */}
        <Fade in={userExcuse} >
